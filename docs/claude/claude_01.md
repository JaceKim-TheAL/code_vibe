...
| ![그림4](./images/0104_claude-projects.png) |
|:---:|
| Fig4. 클로드 프로젝트 |
...
<ol>
  <li> <b>코드 작성 및 수정:</b> 클로드 AI가 작성한 코드를 실시간으로 확인하고 수정할 수 있습니다.
  <li> <b>디자인 검토:</b> 생성된 디자인을 미리보기 창에서 바로 확인할 수 있습니다.
  <li> <b>버전 관리:</b> 아티펙트의 이전 버전을 저장하고 필요할 때 복원할 수 있습니다.
</ol>
