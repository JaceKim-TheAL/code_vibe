...
위 설정에서 `username` 을 자신의 사용자 이름으로 변경하고, Claude Desktop을 재시작하면 MCP 서버가 활성화됩니다.
...
| ![그림1](./img/fig01_available-mcp.png) |
|:---:|
| Fig1. MCP 도구 (Tools) 확인 |

도구 버튼을 누르게되면 아래와 같이 사용 가능한 MCP 서버를 확인 할 수 있습니다.

| ![그림2](./img/fig02_check-mcp-tools.png) |
|:---:|
| Fig2. 사용가능한 MCP서버 확인 |
