...
| ![그림1](./img/fig01_프롬프트-기본구조.png) |
|:---:|
| Fig1. 프롬프트 엔지니어링 기본 구조 |
...
| ![그림2](./img/fig02_기초-프롬프트-사례.png) |
|:---:|
| Fig2. 프롬프트 엔지니어링 작성 사례 |
...
- [[프롬프트 엔지니어링 가이드 (Prompt Engineering Guide)]](https://www.promptingguide.ai/) 내용을 참고 하여 작성 하였습니다.
