...
- [클로드 코드 서브 에이전트 (Sub Agent) 사용법](#클로드-코드-서브-에이전트-sub-agent-사용법)
- [클로드 코드 서브 에이전트란?](#클로드-코드-서브-에이전트란)
- [클로드 코드 서브 에이전트의 주요 기능](#클로드-코드-서브-에이전트의-주요-기능)
- [클로드 코드 서브 에이전트 사용법](#클로드-코드-서브-에이전트-사용법)
- [클로드 코드 서브 에이전트를 활용한 개발 워크플로우 최적화](#클로드-코드-서브-에이전트를-활용한-개발-워크플로우-최적화)
- [클로드 코드 서브 에이전트 도입 시 고려사항](#클로드-코드-서브-에이전트-도입-시-고려사항)
- [클로드 코드 서브 에이전트의 미래와 전망](#클로드-코드-서브-에이전트의-미래와-전망)
- [참고자료](#참고자료)

---
# 클로드 코드 서브 에이전트 (Sub Agent) 사용법 
> 개발 생산성 200% 높이는 방법
...
| ![그림1](./img/fig01_claude-sub-agent-key-benefits.png) |
|:---:|
| Fig1. 클로드 코드 서브 에이전트의 주요 기능 |
...
| ![그림2](./img/fig02_claude-sub-agent-usage-guide-summary.png) |
|:---:|
| Fig2. 클로드 코드 서브 에이전트 사용법 |
...
| ![그림3](./img/fig03_claude-sub-agent-creation.png) |
|:---:|
| Fig3. 클로드 코드 서브 에이전트 생성 | 
